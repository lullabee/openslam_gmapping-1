...
OrientedPoint FSRMovement::movePoint(const OrientedPoint& pt,
...
OrientedPoint FSRMovement::frameTransformation(
    const OrientedPoint& reference_pt_frame1,
  ...
  FSRMovement tmp =
      composeMoves(composeMoves(trans_refp2, itrans_refp1), trans_pt);
