...
/*  public:  */
/*   struct InputPoint { */
/*     InputPoint(double _x=0.0, double _y=0.0, double _t=0.0) {
 * x=_x;y=_y;t=_t;} */
/*     double x; */
/*     double y; */
/*     double t; */
...
/*     } */
/*     double denom =
 * sqr(m_parzenWindow.x)*sqr(m_parzenWindow.x)*sqr(m_parzenWindow.x) * (sum_y) *
 */
/*       sqrt(sqr(m_parzenWindow.x) + sqr(m_parzenWindow.y) +
 * sqr(m_parzenWindow.t)); */
/*     p *= 1./denom;  */
