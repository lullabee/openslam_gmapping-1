...
struct Optimizer {
  ...
  OrientedPoint gradientDescent(const RangeReading& oldReading,
...
template <typename Likelihood, typename Map>
OrientedPoint Optimizer<Likelihood, Map>::gradientDescent(
    const RangeReading& reading, const OrientedPoint& pose, OLocalMap& lmap) {
