...
#define MEMBER_PARAM_SET_GET(member, type, name, qualifier, setqualifier, \
                             getqualifier)                                \
  getqualifier:                                                           \
...
#define MEMBER_PARAM_SET(member, type, name, qualifier, setqualifier, \
                         getqualifier)                                \
  setqualifier:                                                       \
  inline void set##name(type name) { member.set##name(name); }

#define MEMBER_PARAM_GET(member, type, name, qualifier, setqualifier, \
                         getqualifier)                                \
  getqualifier:                                                       \
  inline type get##name() const { return member.get##name(); }

#define STRUCT_PARAM_SET_GET(member, type, name, qualifier, setqualifier, \
                             getqualifier)                                \
  getqualifier:                                                           \
...
#define STRUCT_PARAM_SET(member, type, name, qualifier, setqualifier, \
                         getqualifier)                                \
  setqualifier:                                                       \
  inline void set##name(type name) { member.name = name; }

#define STRUCT_PARAM_GET(member, type, name, qualifier, setqualifier, \
                         getqualifier)                                \
  getqualifier:                                                       \
  inline type get##name() const { return member.name; }
